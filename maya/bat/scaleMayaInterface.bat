...
:: Set the path of the Maya file to replace
set mayaConfigFile="%USERPROFILE%\Documents\maya\2016\prefs\MayaInterfaceScalingConfig"
...
if not x"%myvar:3200=%"==x"%myvar%" (
	copy "./MayaInterfaceScalingConfigMax" !mayaConfigFile!
	echo One monitor configuration
) ELSE (
	copy "./MayaInterfaceScalingConfigMin" !mayaConfigFile!
