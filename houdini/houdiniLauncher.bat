...
set GLM_OFFICIAL_VERSION=8.2.6-2023.12.14-#2925
::set GLM_OFFICIAL_VERSION=9-2023.10.25-#2869
set HOUDINI_VERSION=19.5.716
set HOUDINI_BVERSION=195
...
IF %GLM_MODE% == Official (
	set GLM_INSTALL_PREFIX=C:\Program Files\Golaem\Golaem-%GLM_OFFICIAL_VERSION%-Houdini%HOUDINI_IVERSION%-Python39-windows
)
