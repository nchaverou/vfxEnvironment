...
set CMAKE_PROJECT=Golaem8-Maya2018
...
set CMAKE_VARS=%CMAKE_VARS% -DMAYA_VERSION=%DCC_VERSION% -DHOUDINI_VERSION=%HOUDINI_VERSION%
set CMAKE_VARS=%CMAKE_VARS% -DBUILD_CROWD=%BUILD_CROWD% -DBUILD_HOUDINI=%BUILD_HOUDINI% -DBUILD_SAMPLES=%BUILD_SAMPLES% -DBUILD_TESTS=%BUILD_TESTS%
