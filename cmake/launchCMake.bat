...
set CMAKE_VARS=%CMAKE_VARS% -DBUILD_CROWD=%BUILD_CROWD% -DBUILD_KATANA=%BUILD_KATANA% -DBUILD_HOUDINI=%BUILD_HOUDINI% -DBUILD_3DSMAXVRAY=%BUILD_MAX% -DBUILD_SAMPLES=%BUILD_SAMPLES% -DBUILD_TESTS=%BUILD_TESTS%
