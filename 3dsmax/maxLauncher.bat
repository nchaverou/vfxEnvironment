...
set VRAY5_FOR_3DSMAX2022_PLUGINS=%GLM_VRAY_PLUGINS_PATH%;%VRAY5_FOR_3DSMAX2022_PLUGINS%;
set VRAY6_FOR_3DSMAX2020_PLUGINS=%GLM_VRAY_PLUGINS_PATH%;%VRAY6_FOR_3DSMAX2020_PLUGINS%;
set VRAY6_FOR_3DSMAX2022_PLUGINS=%GLM_VRAY_PLUGINS_PATH%;%VRAY6_FOR_3DSMAX2022_PLUGINS%;
set VRAY6_FOR_3DSMAX2023_PLUGINS=%GLM_VRAY_PLUGINS_PATH%;%VRAY6_FOR_3DSMAX2023_PLUGINS%;
set VRAY_FOR_3DSMAX2020_PLUGINS=%GLM_VRAY_PLUGINS_PATH%;%VRAY_FOR_3DSMAX2020_PLUGINS%;
set VRAY_FOR_3DSMAX2022_PLUGINS=%GLM_VRAY_PLUGINS_PATH%;%VRAY_FOR_3DSMAX2022_PLUGINS%;
