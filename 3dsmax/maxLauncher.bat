...
set GLM_INSTALL_PREFIX=C:\Users\chaverou\Downloads\Golaem-6.4.3-2019.02.27-#1699\Golaem-6.4.3-2019.02.27-PR1699-Max2018\GolaemCrowd
...
set VRAY4_FOR_3DSMAX2018_PLUGINS=%GLM_VRAY_PLUGINS_PATH%;%VRAY30_RT_FOR_3DSMAX2018_PLUGINS_x64%;
